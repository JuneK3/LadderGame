...
public class LadderTest {
	...
	public void testDrawLineWhenRowIsOverLimit() {
		try {
			LadderGame ladderGame = new LadderGame(new NaturalNumber(4), new NaturalNumber(3));
	...
	public void testRunWhenNoLine() {
		LadderGame ladderGame = new LadderGame(new NaturalNumber(1), new NaturalNumber(3));
	...
	public void testRunWhenLineLeft() {
		...
		// 0 1 1
		ladderGame = new LadderGame(new NaturalNumber(1), new NaturalNumber(3));
